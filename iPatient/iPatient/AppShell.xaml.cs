...
public partial class AppShell : Shell
{
	public AppShell()
	{
        ...
        Routing.RegisterRoute("BookingOptions/FindFacility", typeof(FindFacilityPage));
        Routing.RegisterRoute("BookingOptions/FindFacility/FindDoctor", typeof(FindDoctorPage));
